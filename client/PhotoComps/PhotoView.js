    ...
    switch(this.props.photoItems) {
        case 'north-america':
            return ['http://d38zt8ehae1tnt.cloudfront.net/A_Trippy_American_Propaganda_Video_From_The_1970s__148241.jpg?v=1375686324',
                    'http://d38zt8ehae1tnt.cloudfront.net/A_Trippy_American_Propaganda_Video_From_The_1970s__148241.jpg?v=1375686324',
                    'http://d38zt8ehae1tnt.cloudfront.net/A_Trippy_American_Propaganda_Video_From_The_1970s__148241.jpg?v=1375686324']
            break;
        case 'europe':
  ...
  whatPhotoFormat: function(){
    ...
    return (   
          <div className="col-md-4">
            <img src={ item } className="img-fluid img-rounded" alt="Responsive image"/>
          </div>
            )
    })
    return (
